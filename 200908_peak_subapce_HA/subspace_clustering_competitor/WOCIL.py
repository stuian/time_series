...
def main():
    path = './data/'
    data_name = ['lp1','lp5','wafer298','net534','cricket', 'JapaneseVowels','ArticularyWord', 'char', 'uWaveGestureLibrary','ArabicDigits']
